...
class ArticleSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $sokaCategory = Category::firstOrCreate(
            ['slug' => 'soka'], 
            ['name' => 'Soka', 'is_active' => true, 'is_visible_in_nav' => true]
        );
        
        $burudaniCategory = Category::firstOrCreate(
            ['slug' => 'burudani'], 
            ['name' => 'Burudani', 'is_active' => true, 'is_visible_in_nav' => true]
        );
        
        $spotiKenyaCategory = Category::firstOrCreate(
            ['slug' => 'spoti-kenya'], 
            ['name' => 'Spoti Kenya', 'is_active' => true, 'is_visible_in_nav' => true]
        );
        
        $pichaCategory = Category::firstOrCreate(
            ['slug' => 'picha'], 
            ['name' => 'Picha', 'is_active' => true, 'is_visible_in_nav' => true]
        );
        
        $videoCategory = Category::firstOrCreate(
            ['slug' => 'video'], 
            ['name' => 'Video', 'is_active' => true, 'is_visible_in_nav' => true]
        );

        // 2. Define the articles payload
        $articles = [
            [
                'title' => 'Mabingwa Watetezi Wapewa Mtihani Mgumu Ulaya',
                'slug' => 'mabingwa-watetezi-wapewa-mtihani-mgumu-ulaya',
                'category_id' => $spotiKenyaCategory->id, // Successfully reassigned from Spoti Majuu
            ...
            // You can add more dummy articles here as needed
        ];

        // 3. Upsert the articles to avoid duplication errors if run multiple times
...
//         $sokaCategory = Category::firstOrCreate(['name' => 'Soka'], ['slug' => 'soka', 'is_active' => true, 'is_visible_in_nav'=>'true']);
//         $burudaniCategory = Category::firstOrCreate(['name' => 'Burudani'], ['slug' => 'burudani', 'is_active' => true, 'is_visible_in_nav'=>'true']);
//         $kolamuCategory = Category::firstOrCreate(['name' => 'Kolamu'], ['slug' => 'kolamu', 'is_active' => true, 'is_visible_in_nav'=>'true']);
//         $spotiMajuuCategory = Category::firstOrCreate(['name' => 'Spoti Majuu'], ['slug' => 'spoti-majuu', 'is_active' => true, 'is_visible_in_nav'=>'true']);
//         $spotiKenyaCategory = Category::firstOrCreate(['name' => 'Spoti Kenya'], ['slug' => 'spoti-kenya', 'is_active' => true, 'is_visible_in_nav'=>'true']);

//         $hadithiCategory = Category::updateOrCreate(['slug' => 'hadithi'], ['name' => 'Hadithi', 'is_active' => true, 'is_visible_in_nav'=>'true']);
//         $pichaCategory = Category::updateOrCreate(['slug' => 'picha'], ['name' => 'Picha', 'is_active' => true, 'is_visible_in_nav'=>'true']);
//         $externalCategory = Category::updateOrCreate(['slug' => 'external'], ['name' => 'External', 'is_active' => true, 'is_visible_in_nav'=>'true']);
//         $videoCategory = Category::updateOrCreate(['slug' => 'video'], ['name' => 'Video', 'is_active' => true, 'is_visible_in_nav'=>'true']);
//         $mafumboCategory = Category::updateOrCreate(['slug' => 'mafumbo'], ['name' => 'Mafumbo', 'is_active' => true, 'is_visible_in_nav'=>'true']);
...
//                 'category_id' => $spotiKenyaCategory->id,
...
//                 'title' => 'Kikosi cha Timu ya Taifa Kuanza Kambi Wiki Hii',
//                 'slug' => 'kikosi-cha-timu-ya-taifa-kuanza-kambi-wiki-hii',
//                 'category_id' => $mafumboCategory->id,
//                 'tentacle_id' => 'TNT-FUMB-006',
//                 'topic_label' => 'Soka la Ndani',
//                 'summary' => 'Maandalizi ya mechi za kufuzu yanaendelea huku kocha mkuu akitangaza majina mapya.',
//                 'content' => 'Mabadiliko makubwa yamefanyika kwenye safu ya ushambuliaji...',
//                 'layout_type' => 'grid',
...
//                 'title' => 'Tamasha Kuu la Burudani Kung\'aa Wikiendi Hii Pwani',
//                 'slug' => 'tamasha-kuu-la-burudani-kungaa-wikiendi-hii-pwani',
//                 'category_id' => $hadithiCategory->id,
//                 'tentacle_id' => 'TNT-HADTH-007',
//                 'topic_label' => 'Burudani',
//                 'summary' => 'Wasanii mashuhuri wamethibitisha kuhudhuria tamasha la mwaka huku tiketi zikiisha kwa kasi.',
//                 'content' => 'Maandalizi ya jukwaa kuu yamekamilika...',
//                 'layout_type' => 'list',
...
//                 'title' => 'Maoni: Nini Kinaikwamisha Soka Letu Katika Ngazi ya Kimataifa?',
//                 'slug' => 'maoni-nini-kinaikwamisha-soka-letu-katika-ngazi-ya-kimataifa',
//                 'category_id' => $pichaCategory->id,
//                 'tentacle_id' => 'TNT-PICH-008',
//                 'topic_label' => 'Uchambuzi',
//                 'summary' => 'Tathmini ya kina kuhusu changamoto zinazokabili vilabu vyetu kwenye mashindano makubwa.',
//                 'content' => 'Ukosefu wa miundombinu thabiti ni mojawapo ya sababu kuu...',
//                 'layout_type' => 'list',
