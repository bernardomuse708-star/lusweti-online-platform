...
class ArticleSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $kolamuCategory = Category::firstOrCreate(
            ['slug' => 'kolamu'],
            ['name' => 'Kolamu', 'is_active' => true, 'is_visible_in_nav' => true]
        );

        $spotiMajuuCategory = Category::firstOrCreate(
            ['slug' => 'spoti-majuu'],
            ['name' => 'Spoti Majuu', 'is_active' => true, 'is_visible_in_nav' => true]
        );
        ...
        $hadithiCategory = Category::updateOrCreate(
            ['slug' => 'hadithi'],
            ['name' => 'Hadithi', 'is_active' => true, 'is_visible_in_nav' => true]
        );

        $pichaCategory = Category::updateOrCreate(
            ['slug' => 'picha'],
            ['name' => 'Picha', 'is_active' => true, 'is_visible_in_nav' => true]
        );

        $externalCategory = Category::updateOrCreate(
            ['slug' => 'external'],
            ['name' => 'External', 'is_active' => true, 'is_visible_in_nav' => true]
        );

        $videoCategory = Category::updateOrCreate(
            ['slug' => 'video'],
            ['name' => 'Video', 'is_active' => true, 'is_visible_in_nav' => true]
        );

        $mafumboCategory = Category::updateOrCreate(
            ['slug' => 'mafumbo'],
            ['name' => 'Mafumbo', 'is_active' => true, 'is_visible_in_nav' => true]
        );

        // 2. Article Payload with seed filenames
        $articles = [
            [
            ...
            [
                'title' => 'Kikosi cha Timu ya Taifa Kuanza Kambi Wiki Hii',
                'slug' => 'kikosi-cha-timu-ya-taifa-kuanza-kambi-wiki-hii-2',
            ...
            [
                'title' => 'Tamasha Kuu la Burudani Kung\'aa Wikiendi Hii Pwani',
                'slug' => 'tamasha-kuu-la-burudani-kungaa-wikiendi-hii-pwani-2',
            ...
            [
                'title' => 'Maoni: Nini Kinaikwamisha Soka Letu Katika Ngazi ya Kimataifa?',
                'slug' => 'maoni-nini-kinaikwamisha-soka-letu-katika-ngazi-ya-kimataifa-2',
            ...
            [
                'title' => 'Mabingwa Watetezi Wapewa Mtihani Mgumu Ulaya',
                'slug' => 'mabingwa-watetezi-wapewa-mtihani-mgumu-ulaya-2',
            ...
            [
                'title' => 'Mchezaji Nyota Akataa Mkataba Mpya, Kutafuta Malisho Mengine',
                'slug' => 'mchezaji-nyota-akataa-mkataba-mpya-kutafuta-malisho-mengine-2',
