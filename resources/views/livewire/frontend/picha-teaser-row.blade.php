            ...
            <article
                ...
                <a
                    ...
                    <div class="relative overflow-hidden">
                        ...
                        {{-- Gallery Icon --}}
                        <div class="absolute top-4 left-4 w-12 h-12 rounded-full backdrop-blur-md bg-white/20 border border-white/30 flex items-center justify-center">
                        ...
                        {{-- Gallery Badge --}}
                        <div
                            class="absolute text-slate-800 top-4 right-4 px-3 py-1 rounded-full text-xs font-bold">
                            {{--
                            style="
